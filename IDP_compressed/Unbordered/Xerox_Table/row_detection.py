...
from MinHVRunLengthCal import MinHVRunLengthCal, PixVRLCal
...
def row_detection(GryImg):
    ...
    BwImgOrg = BwImg
    MinHVRLMat, MinHVRLModeVal, MinHVRLSecondModeVal, MinHVRLMinVal, MinHVRLMaxVal = MinHVRunLengthCal(BwImgOrg)
    ...
    VRunLengthMat, VRunLengthMode, VRunLengthMax = PixVRLCal(DilateImg)
